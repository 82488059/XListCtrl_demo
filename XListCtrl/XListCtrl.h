...
///////////////////////////////////////////////////////////////////////////////
		...
		#ifdef _UNICODE	
			#ifdef _DEBUG
				#pragma comment(lib,"XListCtrlDDDU32.lib")
				#pragma message("Automatically linking with XListCtrlDDDU32.lib")
			#else
				#pragma comment(lib,"XListCtrlDDRU32.lib")
				#pragma message("Automatically linking with XListCtrlDDRU32.lib")
			#endif
		#else
			#ifdef _DEBUG
				#pragma comment(lib,"XListCtrlDDDA32.lib")
				#pragma message("Automatically linking with XListCtrlDDDA32.lib")
			#else
				#pragma comment(lib,"XListCtrlDDRA32.lib")
				#pragma message("Automatically linking with XListCtrlDDRA32.lib")
			#endif
		#endif
		...
		#ifdef _UNICODE
			#ifdef _DEBUG
				#pragma comment(lib,"XListCtrlDSDU32.lib")
				#pragma message("Automatically linking with XListCtrlDSDU32.lib")
			#else
				#pragma comment(lib,"XListCtrlDSRU32.lib")
				#pragma message("Automatically linking with XListCtrlDSRU32.lib")
			#endif
		#else
			#ifdef _DEBUG
				#pragma comment(lib,"XListCtrlDSDA32.lib")
				#pragma message("Automatically linking with XListCtrlDSDA32.lib")
			#else
				#pragma comment(lib,"XListCtrlDSRA32.lib")
				#pragma message("Automatically linking with XListCtrlDSRA32.lib")
			#endif
		#endif
	#elif !defined _AFXDLL && defined XLISTCTRLLIB_STATIC
		...
		#ifdef _UNICODE
			#ifdef _DEBUG
				#pragma comment(lib,"XListCtrlSSDU32.lib")
				#pragma message("Automatically linking with XListCtrlSSDU32.lib")
			#else
				#pragma comment(lib,"XListCtrlSSRU32.lib")
				#pragma message("Automatically linking with XListCtrlSSRU32.lib")
			#endif
		#else
			#ifdef _DEBUG
				#pragma comment(lib,"XListCtrlSSDA32.lib")
				#pragma message("Automatically linking with XListCtrlSSDA32.lib")
			#else
				#pragma comment(lib,"XListCtrlSSRA32.lib")
				#pragma message("Automatically linking with XListCtrlSSRA32.lib")
			#endif
		#endif
	#else
		#pragma message(" ")
